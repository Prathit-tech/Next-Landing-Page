    ...
    return(
        ...
        <Container>
            <Row>
                <Col lg={4}>
                    <div className="mb-4">
                        <p className="text-muted mt-4 mb-2">paynager0@gmail.com</p>
                        <h6 className="text-muted font-weight-normal">+91 8217733706</h6>
                    </div>
                </Col>
                <Col lg={8}>
                    <Row>
                        ...
                        <Col md={4}>
                            ...
                            <p className="text-muted f-14">Bangalore, Karnataka</p>
                            <h6 className="text-muted pb-2">Email: paynager0@gmail.com</h6>
